/**
 * Store page — the e-commerce section (/store).
 * Re-uses the existing Products component with updated internal link base.
 */
          ...
          {isLoading ? (
            ...
            <>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6">
                {data?.items.map((p) => <ProductCard key={p.id} product={p} basePath="/store" />)}
              </div>
              {data && data.pages > 1 && (
